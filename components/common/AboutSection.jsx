          ...
          <div className="space-y-8">
            ...
            <div className="flex mx-auto sm:flex-row gap-4 pt-2">
              <Link href="/gioi-thieu-bt-academy">
                <button 
                  className="text-white px-5 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
                  style={{
              ...
              <Link href="/khoa-hoc">
                <button className="btn-white text-gray-700 hover:text-blue-600 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105">
                  Xem khóa học
                </button>
              </Link>
