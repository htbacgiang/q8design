            ...
            <div ref={rightSectionRef} className="opacity-0">
              ...
              >
                ...
                <button
                  ...
                  className="w-full bg-orange-500 text-white font-semibold py-3 rounded-full hover:bg-orange-600 transition-colors disabled:bg-gray-300 flex items-center justify-center gap-2"
              ...
              {status && (
                <p
                  className={`mt-2 text-center ${
                    status.includes("thành công") ? "text-orange-600" : "text-red-600"
                  }`}
                >
                  {status}
                </p>
