...
export default function ServicesPage() {
  const mainServices = [
    ...
    },
    {
      ...
      description: "Đồng hành cùng khách hàng từ khâu ý tưởng đến khi hoàn thiện dự án. Chúng tôi không chỉ cung cấp dịch vụ thiết kế và thi công mà còn là người bạn đồng hành đáng tin cậy.",
      ...
      services: [
        {
          ...
          image: "/images/q8design/architecture-townhouse.jpg"
        },
        {
          name: "Thiết kế kiến trúc biệt thự", 
          description: "Biệt thự đẳng cấp với phong cách kiến trúc độc đáo",
          image: "/images/q8design/architecture-villa.jpg"
        },
        {
          name: "Thiết kế kiến trúc thương mại",
          description: "Công trình thương mại hiện đại, thu hút khách hàng",
          image: "/images/q8design/architecture-commercial.jpg"
        },
        {
          name: "Thiết kế quy hoạch khu đô thị",
          description: "Quy hoạch tổng thể cho các khu đô thị mới", 
          image: "/images/q8design/architecture-urban.jpg"
        },
        {
          name: "Tư vấn cải tạo kiến trúc",
          description: "Nâng cấp và cải tạo công trình hiện có",
          image: "/images/q8design/architecture-renovation.jpg"
        }
      ]
    },
    interior: {
      ...
      <section className="relative md:h-[60vh] h-[40vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-4xl mx-auto px-4">
          ...
          <h1 className="text-2xl md:text-6xl font-bold mb-4">
            Dịch vụ <span className="text-orange-400">Kiến tạo không gian sống</span>
          </h1>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-16">
            {mainServices.map((service, index) => {
              ...
              const colorClass = 'bg-orange-500 text-orange-600 bg-orange-50';
                  ...
                  <div className={index % 2 === 1 ? 'lg:col-start-1' : ''}>
                    ...
                    <Link
                      href={`/dich-vu/${service.title === 'Thiết kế Kiến trúc' ? 'thiet-ke-kien-truc' 
                        ...
                        : service.title === 'Cải tạo không gian' ? 'cai-tao-khong-gian'
                        : 'tu-van-ho-tro'}`}
                      className={`inline-flex items-center px-6 py-3 ${colorClass.split(' ')[0]} text-white font-semibold rounded-full hover:opacity-90 transition-all duration-300 group`}
                    >
                      Xem chi tiết
            ...
            {servicesByType.architecture.services.map((service, index) => (
              <div key={index} className="group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div className="p-6">
                  ...
                  <Link href="#" className="inline-flex items-center text-orange-600 hover:text-orange-700 font-medium transition-colors group/link">
                    Tìm hiểu thêm
                  ...
                  <div key={index} className="text-center">
                    <div className="relative mb-6">
                      ...
                      {index < workflowSteps.length - 1 && (
                        <div className="hidden md:block absolute top-10 left-full w-full h-1 bg-orange-200 -z-10"></div>
                      )}
                    </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/lien-he"
                className="inline-flex items-center px-8 py-4 bg-white text-orange-600 font-semibold rounded-full hover:bg-gray-100 transition-colors duration-300"
              >
