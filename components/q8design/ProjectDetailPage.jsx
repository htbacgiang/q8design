    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/du-an" className="inline-flex items-center px-6 py-3 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-full transition-colors">
            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-50 rounded-3xl p-8 sticky top-8">
                ...
                <div className="space-y-3">
                  <Link
                    href="/lien-he"
                    className="w-full bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-full text-center transition-colors duration-300 flex items-center justify-center"
                  >
        ...
        <section className="py-20 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mt-12">
              <Link
                href="/du-an"
                className="inline-flex items-center px-8 py-4 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-full transition-colors duration-300"
              >
                Xem tất cả dự án
      ...
      <section className="py-20 bg-gray-900 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-row gap-4 justify-center flex-nowrap">
            <Link
              href="/lien-he"
              className="inline-flex items-center px-10 py-4 bg-orange-500 hover:bg-orange-600 text-white font-semibold rounded-full transition-colors duration-300"
            >
              Liên hệ tư vấn
            </Link>
            <Link
              href="/dich-vu"
              className="inline-flex items-center px-8 py-4 border-2 border-gray-600 text-gray-300 hover:border-white hover:text-white font-semibold rounded-full transition-all duration-300"
            >
              Xem dịch vụ
            </Link>
          </div>
