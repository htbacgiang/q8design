      ...
      <section className="relative md:h-[70vh] h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-5xl mx-auto px-4">
          ...
          <h1 className="text-3xl md:text-6xl font-bold mb-6">
            Dịch vụ <span className="text-orange-400">Cải tạo Không gian</span>
          </h1>
              ...
              <div key={index} className="bg-white rounded-3xl overflow-hidden shadow-xl">
                <div className="grid grid-cols-1 md:grid-cols-2">
                  <div className="relative h-80">
                    ...
                    />
                    <div className="absolute top-4 left-4 bg-gray-800 text-white px-4 py-2 rounded-full font-semibold">
                      Trước cải tạo
                    </div>
                  </div>
                  <div className="relative h-80">
