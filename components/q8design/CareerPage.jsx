              ...
              <div key={position.id} className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-bold py-3 px-6 rounded-full transition-colors duration-300"
                  >
                    Xem chi tiết
                  </button>
                  <button
                    ...
                    className="flex-1 border-2 border-orange-500 text-orange-600 hover:bg-orange-500 hover:text-white font-bold py-3 px-6 rounded-full transition-all duration-300"
                  >
                    Ứng tuyển ngay
                  </button>
                </div>
          ...
          <div className="bg-white rounded-3xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            <div className="p-8">
              ...
              <div className="flex space-x-4 mt-8">
                ...
                <button
                  onClick={() => setSelectedPosition(null)}
                  className="flex-1 border-2 border-gray-300 text-gray-700 hover:bg-gray-50 font-bold py-3 px-6 rounded-full transition-all duration-300"
                >
                  Đóng
                </button>
              </div>
