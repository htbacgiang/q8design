  ...
  const teamTestimonials = [
    {
      ...
      image: "/images/q8design/team-testimonial-1.jpg",
    ...
    },
    {
      ...
      image: "/images/q8design/team-testimonial-2.jpg", 
    ...
    },
    {
      ...
      image: "/images/q8design/team-testimonial-3.jpg",
      ...
      <section className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white max-w-6xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">
            Kiến tạo giá trị, <br />
            <span className="text-orange-400">Xây dựng sự nghiệp</span> cùng Q8 Design
          </h1>
                ...
                <div key={index} className="bg-white rounded-2xl p-6 shadow-lg">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-orange-600">{testimonial.position}</p>
                    </div>
                  </div>
              ...
              <div key={position.id} className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
                ...
                <div className="flex space-x-3">
                  <button
                    ...
                    className="flex-1 bg-orange-500 hover:bg-orange-600 text-white font-semibold py-3 px-6 rounded-full transition-colors duration-300"
                  >
                    Xem chi tiết
                  </button>
                  <button
                    ...
                    className="flex-1 border-2 border-orange-500 text-orange-600 hover:bg-orange-500 hover:text-white font-semibold py-3 px-6 rounded-full transition-all duration-300"
                  >
                    Ứng tuyển ngay
                  </button>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center">
                <div className="w-16 h-16 bg-orange-500 rounded-full flex items-center justify-center mx-auto mb-6 text-white font-bold text-xl">
                  {item.step}
                </div>
                <h3 className="text-xl font-bold text-gray-900 mb-3">
                  {item.title}
            ...
            <div className="p-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8 text-sm">
                <div className="bg-gray-50 p-4 rounded-xl">
                  <FaMapMarkerAlt className="text-orange-500 mb-2" />
                  <div className="font-medium">Địa điểm</div>
                  <div className="text-gray-600">{selectedPosition.location}</div>
                </div>
                <div className="bg-gray-50 p-4 rounded-xl">
                  <FaClock className="text-orange-500 mb-2" />
                  <div className="font-medium">Loại hình</div>
                  <div className="text-gray-600">{selectedPosition.type}</div>
                </div>
                <div className="bg-gray-50 p-4 rounded-xl">
                  <FaBriefcase className="text-orange-500 mb-2" />
                  <div className="font-medium">Cấp bậc</div>
                  <div className="text-gray-600">{selectedPosition.level}</div>
                </div>
                <div className="bg-gray-50 p-4 rounded-xl">
                  <FaDollarSign className="text-orange-500 mb-2" />
                  <div className="font-medium">Lương</div>
                  <div className="text-gray-600">{selectedPosition.salary}</div>
                </div>
              </div>
              ...
              <div className="flex space-x-4 mt-8">
                ...
                <button
                  onClick={() => setSelectedPosition(null)}
                  className="flex-1 border-2 border-gray-300 text-gray-700 hover:bg-gray-50 font-semibold py-3 px-6 rounded-full transition-all duration-300"
                >
                  Đóng
                </button>
              </div>
              ...
              <form onSubmit={handleApplicationSubmit} className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full py-3 px-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full py-3 px-4 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent resize-none"
