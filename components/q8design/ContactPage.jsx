        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              {/* Social Media */}
              <div>
                <p className="text-lg font-bold text-gray-900 mb-4">Kết nối với chúng tôi</p>
              ...
              <div className="bg-white rounded-3xl overflow-hidden shadow-lg h-96">
                ...
                <div className="w-full h-full bg-gray-200 flex items-center justify-center">
                  <div className="text-center text-gray-500">
                    ...
                    <p>Google Map sẽ được tích hợp tại đây</p>
                    <p className="text-sm mt-2">Hiển thị vị trí văn phòng Q8 Design</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        />
                        <FaRuler className="absolute left-4 top-1/2 transform -translate-y-1/2 text-gray-400" />
                      </div>
                    </div>
                  </div>
                  ...
                  <button
                    ...
                    className="w-full bg-orange-500 hover:bg-orange-600 disabled:bg-gray-400 text-white font-semibold py-4 px-6 rounded-xl transition-colors duration-300 flex items-center justify-center"
                  >
                    {isSubmitting ? (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        value={formData.name}
                        onChange={handleInputChange}
                        className={`w-full py-3 px-4 border rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent ${
                          errors.name ? 'border-red-500' : 'border-gray-300'
                        }`}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <label className="flex items-center p-4 border border-gray-300 rounded-xl cursor-pointer hover:bg-gray-50 transition-colors">
                        ...
                        <div className="ml-3">
                          ...
                          <div className="text-sm text-gray-600">Gặp mặt trực tiếp tại văn phòng Q8 Design</div>
                        </div>
                      </label>
