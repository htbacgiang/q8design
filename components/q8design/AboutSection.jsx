      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-24">
          <div className="inline-block mb-8">
            <span className="inline-flex items-center px-6 py-3 bg-white border-2 border-gray-200 rounded-full text-sm font-semibold tracking-widest uppercase text-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:border-gray-300">
              Về chúng tôi
            </span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-20 md:px-0 px-2">
          {coreValues.map((value, index) => {
            ...
            return (
              ...
              >
                {/* Number Badge */}
                <div className="absolute -top-6 -right-6 w-12 h-12 bg-gradient-to-br from-gray-900 to-gray-700 text-white rounded-full flex items-center justify-center text-sm font-bold group-hover:scale-110 group-hover:rotate-12 transition-all duration-300 shadow-lg">
                  {value.number}
                </div>

                {/* Icon */}
                <div className="w-20 h-20 bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl flex items-center justify-center mb-8 group-hover:from-gray-900 group-hover:to-gray-800 group-hover:scale-110 transition-all duration-300 shadow-lg group-hover:shadow-xl">
                  <Icon className="text-3xl text-gray-600 group-hover:text-white transition-colors duration-300" />
                </div>

                {/* Title */}
                <p className="text-2xl font-bold text-gray-900 mb-3 group-hover:text-gray-900 transition-colors duration-300">
                  {value.title}
                </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center md:px-0 px-2">
          ...
          <div className="space-y-8 order-1 lg:order-2 md:px-0 px-2">
            ...
            {/* CTA */}
            <div className="pt-4">
              <Link href="/gioi-thieu" className="group inline-flex items-center px-8 py-4 bg-gray-900 hover:bg-gray-800 text-white font-semibold rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg">
