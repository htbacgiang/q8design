        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-orange-500 to-orange-600 rounded-3xl p-8 md:p-12 text-white text-center">
              <h3 className="text-2xl md:text-3xl font-bold mb-4">Ưu đãi đặc biệt từ Q8 Design</h3>
            ...
            {featuredProjects.slice(0, 2).map((project, index) => (
              <div key={index} className={`bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 ${index % 2 === 0 ? '' : 'md:flex-row-reverse'} flex flex-col md:flex-row`}>
                ...
                <div className="md:w-1/2 p-8 md:p-10 flex flex-col justify-center">
                  ...
                  <p className="text-orange-600 font-bold mb-4">{project.subtitle}</p>
                  ...
                  {project.challenge && (
                    <div className="mb-4">
                      <h4 className="font-bold text-gray-900 mb-2">Thách thức:</h4>
                  ...
                  {project.solution && (
                    <div className="mb-6">
                      <h4 className="font-bold text-gray-900 mb-2">Giải pháp của Q8 Design:</h4>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto">
                Đây là những câu hỏi thường gặp nhất khi khách hàng có nhu cầu cải tạo chung cư. Chúng tôi đã tổng hợp và giải đáp chi tiết để bạn có cái nhìn rõ ràng nhất về quy trình làm việc tại Q8 Design.
              </p>
            </div>
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-6xl mx-auto text-white">
            <p className="text-xl md:text-3xl font-bold mb-2">
              Bắt đầu hành trình kiến tạo không gian sống mơ ước của bạn ngay hôm nay!
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 max-w-3xl mx-auto">
              <div className="grid md:grid-cols-2 gap-4 text-left">
                <div>
                  <p className="text-orange-100 text-sm mb-1">Địa chỉ:</p>
                  <p className="font-bold">Đ. Nam An Khánh - KĐT Nam An Khánh, Hà Nội</p>
                </div>
                <div>
                  <p className="text-orange-100 text-sm mb-1">Hotline / Zalo:</p>
                  <p className="font-bold text-2xl">098 811 68 28</p>
                </div>
              </div>
            </div>
          </div>
