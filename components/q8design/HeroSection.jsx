      ...
      <div className="absolute inset-0">
        ...
        <div className="relative z-10 container mx-auto px-4 h-full flex items-center justify-start ">
          ...
          <div className="flex flex-row gap-2 sm:gap-4 mb-6">
            ...
            <button className="group inline-flex items-center justify-center px-3 sm:px-6 py-3 border-2 border-white/60 hover:border-white text-white hover:text-white font-semibold rounded-full transition-all duration-300 backdrop-blur-md hover:bg-white/10 shadow-lg flex-1 sm:flex-none">
