  ...
  const navigationItems = [
    ...
    },
    {
      ...
      dropdownItems: [
        ...
        { name: "Cải tạo không gian", href: "/dich-vu/cai-tao-khong-gian" }
      ]
    },
    {
      name: "Dự án",
                    ...
                    {item.dropdownItems ? (
                      <>
                        <button
                          ...
                          className={`w-full flex items-center justify-between px-5 py-4 rounded-2xl font-semibold transition-all duration-300 shadow-sm hover:shadow-md ${
                            isActivePath(item.href)
                          ...
                          <div className="pl-6 space-y-2">
                            {item.dropdownItems.map((dropdownItem, dropdownIndex) => (
                              <Link
                                key={dropdownIndex}
                                href={dropdownItem.href}
                                className="block px-5 py-3 ml-8 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-all duration-300 border-l-2 border-gray-200 hover:border-orange-300"
                              >
                                {dropdownItem.name}
                              </Link>
                            ))}
