...
const ProductDropdown = () => {
  return (
    <div className="relative group">
      {/* Trigger Button */}
      <Link href="/san-pham" className="cursor-pointer uppercase text-gray-700 hover:text-green-600 font-heading font-bold">
        Sản phẩm
      </Link>
        ...
        <div className="grid grid-cols-3 gap-6 p-6">
          ...
          <div className="font-bold mb-4 text-gray-900 bg-gray-100 border-b border-green-500 border-dotted ">
            ...
            <ul className="space-y-3 pl-2">
              ...
              <li>
                <Link href="/checkout" className="hover:text-green-600">
                  Cart
                </Link>
              </li>
            </ul>
