          ...
          <div className="w-full lg:w-1/2 flex flex-col space-y-6">
            ...
            <div className="bg-gray-50 p-6 rounded-xl">
              ...
              <div className="space-y-3 text-gray-700">
                <div className="flex items-center">
                  <span className="font-bold w-20">Mô tả:</span>
                  <span className="text-gray-600">{productDescription}</span>
                </div>
                <div className="flex items-center">
                  <span className="font-bold w-20">ĐVT:</span>
                  <span className="text-gray-600">{productUnit}</span>
                </div>
                <div className="flex items-center">
                  <span className="font-bold w-20">Tình trạng:</span>
            ...
            <div className="flex items-center space-x-4">
              {quantity > 0 ? (
                ...
                <button
                  onClick={handleAddToCart}
                  disabled={isOutOfStock}
                  className={`bg-green-600 text-white py-3 px-8 rounded-xl flex items-center font-bold transition-all duration-200 ${
                    isOutOfStock 
