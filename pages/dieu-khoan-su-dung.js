              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 md:p-12">
                ...
                <div className="mb-12">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">&ldquo;Chúng tôi&rdquo;, &ldquo;Q8 Design&rdquo;</h3>
                      <p className="text-gray-700">Chỉ Công ty TNHH Q8 Design, có địa chỉ tại Đ. Nam An Khánh - KĐT Nam An Khánh - Hà Nội.</p>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">&ldquo;Bạn&rdquo;, &ldquo;Khách hàng&rdquo;</h3>
                      <p className="text-gray-700">Chỉ cá nhân hoặc tổ chức sử dụng dịch vụ của Q8 Design.</p>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">&ldquo;Dịch vụ&rdquo;</h3>
                      <p className="text-gray-700">Bao gồm thiết kế kiến trúc, thiết kế nội thất, thi công trọn gói và các dịch vụ liên quan.</p>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">&ldquo;Website&rdquo;</h3>
                ...
                <div className="mb-12">
                  ...
                  <div className="space-y-6">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-3">3.1. Cam kết chất lượng</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-3">3.2. Quyền và nghĩa vụ của khách hàng</h3>
                      <div className="grid md:grid-cols-2 gap-6">
                        <div>
                          <h4 className="font-semibold text-gray-800 mb-2">Quyền:</h4>
                        ...
                        <div>
                          <h4 className="font-semibold text-gray-800 mb-2">Nghĩa vụ:</h4>
                          <ul className="list-disc list-inside text-gray-700 space-y-1 text-sm">
                ...
                <div className="mb-12">
                  ...
                  <div className="space-y-4">
                    <div className="bg-orange-50 border-l-4 border-orange-500 p-4">
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">4.1. Phương thức thanh toán</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">4.2. Lịch thanh toán</h3>
                ...
                <div className="mb-12">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">5.1. Thu thập thông tin</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">5.2. Sử dụng thông tin</h3>
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">5.3. Bảo vệ thông tin</h3>
                      <p className="text-gray-700">
                ...
                <div className="mb-12">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">6.1. Trách nhiệm của Q8 Design</h3>
                      <ul className="list-disc list-inside text-gray-700 space-y-2">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">6.2. Trường hợp miễn trừ trách nhiệm</h3>
                      <ul className="list-disc list-inside text-gray-700 space-y-2">
                ...
                <div className="mb-12">
                  ...
                  <div className="space-y-4">
                    <div className="bg-blue-50 border-l-4 border-blue-500 p-4">
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">7.1. Nguyên tắc giải quyết</h3>
                      <p className="text-gray-700">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-800 mb-2">7.2. Luật áp dụng</h3>
                      <p className="text-gray-700">
                ...
                <div className="border-t border-gray-200 pt-8">
                  <div className="bg-orange-50 border border-orange-200 rounded-lg p-6">
                    ...
                    <p className="text-gray-700 mt-3">
                      ...
                      qua hotline <a href="tel:0988116828" className="text-orange-600 hover:text-orange-700 font-semibold">098 811 68 28</a>  
                      hoặc email <a href="mailto:info@q8design.vn" className="text-orange-600 hover:text-orange-700 font-semibold"> info@q8design.vn</a>.
                    </p>
                  </div>
                </div>
