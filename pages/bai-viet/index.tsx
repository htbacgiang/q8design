                ...
                <div className="w-full lg:w-8/12 flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-2">
                    <Link
                      ...
                      className="text-orange-600 lg:text-lg uppercase font-semibold hover:text-orange-700 transition-colors"
                    >
                    ...
                    <div key={post.id} className="flex justify-between gap-4 h-auto lg:h-1/3">
                      ...
                      <div className="w-2/3 flex flex-col justify-center">
                        <div className="flex items-center gap-2 text-sm lg:text-base mb-1">
                          <Link href={`/bai-viet/${post.slug}`} className="text-orange-600 uppercase font-semibold hover:text-orange-700 transition-colors">
                            {post.title}
                          </Link>
                        </div>
