...
export default function Signup({ csrfToken, meta }) {
  ...
  return (
    <>
      ...
      <section className="min-h-screen bg-gradient-to-br from-slate-50 via-orange-50 to-amber-50 flex items-center justify-center p-4">
        {/* Background Pattern */}
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-orange-600 to-amber-600 px-8 py-6 text-center">
              ...
              <p className="text-orange-100 text-sm">Tham gia cộng đồng Q8Design ngay hôm nay</p>
            </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-start">
                        ...
                        <label className="ml-3 text-sm text-gray-600">
                          Tôi đồng ý với{" "}
                          <Link href="/chinh-sach-bao-mat" className="text-orange-600 hover:text-orange-700 font-medium transition-colors">
