        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-2xl border border-gray-100 overflow-hidden">
            ...
            <div className="bg-gradient-to-r from-orange-600 to-amber-600 px-8 py-6 text-center">
              ...
              <p className="text-orange-100 text-sm">Đăng nhập để tiếp tục với Q8Design</p>
            </div>
                ...
                <Form className="space-y-6">
                  ...
                  {/* Email hoặc Số điện thoại */}
                    <div className="space-y-2">
                      <label htmlFor="login_email" className="block text-gray-700 text-sm font-semibold">
                  ...
                  {/* Mật khẩu */}
                    <div className="space-y-2">
                      <label htmlFor="login_password" className="block text-gray-700 text-sm font-semibold">
                  ...
                  {status && (
                    ...
                    <button
                      ...
                      className="w-full py-3 bg-gradient-to-r from-orange-600 to-amber-600 text-white font-semibold rounded-xl hover:from-orange-700 hover:to-amber-700 transition-all duration-300 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-[1.02] disabled:transform-none"
                    >
                      {isSubmitting ? (
                  ...
                  {showResendButton && (
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          disabled={isResending}
                            className="px-4 py-2 bg-amber-600 text-white font-semibold rounded-lg hover:bg-amber-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                        >
                    ...
                    <button
                      ...
                      className="w-full py-3 bg-white border border-gray-300 text-gray-700 font-semibold rounded-xl hover:bg-gray-50 transition-all duration-300 flex items-center justify-center gap-3 shadow-sm hover:shadow-md"
                    >
