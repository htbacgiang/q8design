                ...
                <Form className="space-y-6">
                  ...
                  {/* Email hoặc Số điện thoại */}
                    <div className="space-y-2">
                      <label htmlFor="login_email" className="block text-gray-700 text-sm font-bold">
                  ...
                  {/* Mật khẩu */}
                    <div className="space-y-2">
                      <label htmlFor="login_password" className="block text-gray-700 text-sm font-bold">
                  ...
                  {showResendButton && (
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          disabled={isResending}
                            className="px-4 py-2 bg-amber-600 text-white font-bold rounded-lg hover:bg-amber-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm"
                        >
                    ...
                    <button
                      ...
                      className="w-full py-3 bg-white border border-gray-300 text-gray-700 font-bold rounded-xl hover:bg-gray-50 transition-all duration-300 flex items-center justify-center gap-3 shadow-sm hover:shadow-md"
                    >
